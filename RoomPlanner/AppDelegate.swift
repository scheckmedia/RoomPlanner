...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // https://github.com/andrewcbancroft/Zootastic/blob/BaseProject_SeedDataStore/Zootastic/AppDelegate.swift
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "RoomPlanner", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("RoomPlanner.sqlite")
